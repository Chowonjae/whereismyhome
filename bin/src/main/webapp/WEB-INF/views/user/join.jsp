    ...
    <script>
      ...
      document.querySelector("#userid").addEventListener("keyup", function () {
    	 ...
    	 if(userid.length < 6 || userid.length > 16) {
			...
			fetch("${root}/rmember/user/"+userid)
      ...
      document.querySelector("#btn-join").addEventListener("click", function () {
    	  console.log(document.querySelector("#emailid").value+ "id");
    	  console.log(document.querySelector("#emaildomain").value + "domain");
        if (!document.querySelector("#username").value) {
          ...
          alert("비밀번호 확인!!");
          return;
        } else if (document.querySelector("#emailid").value == ""||document.querySelector("#emaildomain").value=="선택") {
          alert("이메일 확인!!");
          return;
        } else if (!isUseId) {
          alert("아이디 확인!!");
